...
IPAddress server_addr(188,121,57,21);
uint16_t server_port = 3306;    //3306;

char default_database[] = "IOTStorage";           //"test_arduino";
char default_table[]    = "Record";          //"test_arduino";

String default_value    = "Hello, Arduino!"; 

// Sample query
String INSERT_SQL = String("INSERT INTO ") + default_database + "." + default_table
                 + " (RecordType, RecordValue, RecordTimestamp, Name, CreatedBy, DeviceID) VALUES (\"Test\",\"42\",\"2020-11-11\",\"ESP\",\"Postage Stamp\",\"10\")";
